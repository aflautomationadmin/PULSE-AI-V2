-- ============================================================
-- Procedure : kpi.GetDiscountPct
-- KPI        : Discount Percent
--
-- Formula
--   DiscountPct = SUM(DISCOUNT) / NULLIF(SUM(TOTAL_MRP), 0)
--
-- Parameters
...
CREATE OR ALTER PROCEDURE kpi.GetDiscountPct
...
BEGIN
    ...
    SET @sel_cols +=
        ...
        SUM(TOTAL_MRP) AS TotalMRP,
        SUM(DISCOUNT) / NULLIF(SUM(TOTAL_MRP), 0) AS DiscountPct
        ';
    ...
    + CASE
        ...
        ELSE ' ORDER BY DiscountPct DESC'
      END;
